...
(function() {
    ...
    dashboard.style = `
        ...
        background: rgba(15, 15, 15, 0.98); color: white; padding: 18px;
        border-radius: 12px; font-family: 'Segoe UI', Roboto, sans-serif;
        border: 1px solid #ff4d89; min-width: 260px;
        box-shadow: 0 15px 40px rgba(0,0,0,0.6); user-select: none;
    `;
    ...
    dashboard.innerHTML = `
        ...
        <div style="margin-bottom:10px;">
            <div style="font-size:10px; color:#aaa; margin-bottom:4px; text-transform:uppercase;">Target (Optionnal) :</div>
        ...
        <div style="display:flex; gap:8px;">
            <button id="btn-start" style="flex:2; background:#4CAF50; color:white; border:none; padding:8px; border-radius:6px; cursor:pointer; font-weight:bold; font-size:12px; transition: 0.2s;">START</button>
    ...
    // --- LOGIQUE DE CALCUL ET UI ---
    const updateUI = () => {
        document.getElementById('epal-count').innerText = `Cadeaux : ${totalGifts}`;
        ...
        document.getElementById('top-donors').innerHTML = html || "En attente...";
    };
    ...
    const processNode = (node) => {
        ...
        // On cherche le texte spécifique du cadeau
        ...
        if (giftPart && giftPart.innerText.includes("gifted")) {
            ...
            // Détection du donateur (plus large pour éviter les erreurs)
            ...
            // Extraction quantité et type de cadeau
            ...
            if (qtyMatch) {
                ...
                const price = giftPrices[foundGift];
                const totalChange = price * quantity;
    ...
    const startTracker = () => {
        ...
        document.getElementById('btn-start').style.background = "#f44336";
